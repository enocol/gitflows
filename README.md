...
**[Leaderboard]** In this project, I have used a webpack boiler plate created earlier to create a leaderBoard app
...
```sh
git clone https://github.com/enocol/leaderboard
```

then you will see the **leaderboard** on your system then type this:
...
Feel free to check the [issues page](https://github.com/enocol/webpack/issues).
